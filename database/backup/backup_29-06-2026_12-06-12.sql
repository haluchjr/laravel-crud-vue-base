...
--
-- Table structure for table `_personal_access_tokens`
--

DROP TABLE IF EXISTS `_personal_access_tokens`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `_personal_access_tokens` (
...
--
-- Dumping data for table `_personal_access_tokens`
--

LOCK TABLES `_personal_access_tokens` WRITE;
/*!40000 ALTER TABLE `_personal_access_tokens` DISABLE KEYS */;
/*!40000 ALTER TABLE `_personal_access_tokens` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `tb_pedidos` (
  ...
  `validado` int NOT NULL COMMENT 'Pdf validado',
  `boneco_aprovado` int NOT NULL COMMENT 'Se boneco foi ou nao aprovado',
  `data_inclusao` date NOT NULL,
  `data_entrega` date NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `tb_pedidos_fk_cliente_foreign` (`fk_cliente`),
  CONSTRAINT `tb_pedidos_fk_cliente_foreign` FOREIGN KEY (`fk_cliente`) REFERENCES `tb_usuarios` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tb_usuarios` VALUES (9,'Luis','teste@teste.com',NULL,'$2y$12$WFomLjXuYjSSJiua1tR5aO2iOCS/qjh0xnKtpv2y1tT26c1YsfEC2',NULL,'2026-06-22 15:47:20','2026-06-22 15:47:20','99','1'),(10,'admin@local.com','admin@local.com',NULL,'$2y$12$QySZVYH/rlk22Blm3995auAIIa4dzTOp0N3cU7W1czoMvZkXDCJ0m',NULL,'2026-06-29 00:00:45','2026-06-29 00:00:45','1','1');
...
-- Dump completed on 2026-06-29 15:06:12
