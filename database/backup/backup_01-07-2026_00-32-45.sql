...
--
-- Table structure for table `tb_arquivos_pedidos`
--

DROP TABLE IF EXISTS `tb_arquivos_pedidos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tb_arquivos_pedidos` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `tb_arquivos_pedidos_ibfk_1` FOREIGN KEY (`pedido_item_id`) REFERENCES `tb_pedido_itens` (`id`),
  CONSTRAINT `tb_arquivos_pedidos_ibfk_2` FOREIGN KEY (`produto_componente_id`) REFERENCES `tb_componentes` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tb_arquivos_pedidos`
--

LOCK TABLES `tb_arquivos_pedidos` WRITE;
/*!40000 ALTER TABLE `tb_arquivos_pedidos` DISABLE KEYS */;
/*!40000 ALTER TABLE `tb_arquivos_pedidos` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `tb_componentes` VALUES (1,'Frente','frente'),(2,'Capa','capa'),(7,'Miolo','miolo'),(8,'Trás','tras'),(9,'Hot Stamping','hotstamping'),(10,'Verniz Total Frente','verniztotalfrente');
...
INSERT INTO `tb_pedido_itens` VALUES (1,1,1,1,'2026-06-30',60,'60x50','70x60','2026-06-30','2026-06-30','/teste',1),(2,1,1,1,'2026-06-30',9,'5','1','2026-06-30','2026-06-30','/teste',1);
...
INSERT INTO `tb_pedidos` VALUES (1,10,'tete','2026-07-01','2026-06-24','2026-06-30 10:35:54','2026-06-30 10:35:54','nehuma',2,500.20);
...
-- Dump completed on 2026-07-01  3:32:45
